...
🔹 At night, I am a master's student in the PPGI Professional Master's program at the Federal Technological University of Paraná de Cornélio Procópio - UTFPR (2025). I am studying subjects such as Introduction to Artificial Intelligence, in which I developed an article that compares different neural network models for image classification. I also study Data Mining, Natural Language Processing (NLP) and Computer Vision, the latter being the focus of my dissertation, with Vision Transformers (ViTs).
